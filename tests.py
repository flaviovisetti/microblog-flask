...
class UserModelCase(unittest.TestCase):
    ...
    def test_avatar(self):
        ...
        gravatar = 'http://www.gravatar.com/avatar/{}?d=identicon&s=128'.format(digest)
    ...
    def test_follow_posts(self):
        ...
        p2 = Post(body='susan', author=u2, timestamp=now + timedelta(seconds=2))
        p3 = Post(body='mary', author=u3, timestamp=now + timedelta(seconds=3))
        p4 = Post(body='david', author=u4, timestamp=now + timedelta(seconds=4))
